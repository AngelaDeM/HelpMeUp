function CalendarApp(date) {
    ...
    this.months = ['Gennaio', 'Febbraio', 'Marzo', 'Aprile', 'Maggio', 'Giungo', 'Luglio', 'Agosto', 'Settembre', 'Ottobre', 'Novembre', 'Dicembre'];
    this.quotes = [''];
    this.apts = [
{
...
},
{
    ...
    CalendarApp.prototype.openDayWindow = function(date){
        ...
        /* Funzione per hai/non hai eventi giorno selezionato*/
        var _dayTopbarText = '';
        var eventsToday = this.showEventsByDay(day);
        if ( !eventsToday ) {
        _dayTopbarText = "Non ";
        var _rand = Math.round(Math.random() * ((this.quotes.length - 1)));
        ...
        //funzione per la data selezionata
        ...
        this.dayEventsEle.textContent = _dayTopbarText + "eventi il " + day.getDate() + " " + this.months[day.getMonth()] + ", " + day.getFullYear();
